			...
			<div className = 'fit-95'>
				<div className = 'home-intro'>
					<div className = 'text'>
						...
						<span> </span>Jonathon dedicates himself to thrilling clients with the results of their collaboration.
						<br/><br/>
						Contact Jonathon now for your complimentary consultation. Start enjoying the freedom and security that confidential guidance and eloquent application development will bring to your business and personal lives. Read reviews from enthusiastic clients on <a href='https://www.linkedin.com/in/jonathonnagatani' target='_blank' title='Jonathon on LinkedIn'>LinkedIn</a>.
						<br/><br/>
						As an exercise, all applications here are designed and hand-coded from scratch, unless specified otherwise.
						<br/><br/>
						Jonathon Nagatani: making life easier for you.
					</div>
				</div>
			</div>
		);
