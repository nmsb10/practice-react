			...
			<div className = 'fit-95'>
				<div className = 'home-intro'>
					...
					<div className = 'text'>
						...
						<p>Jonathon's mission is simple. Create a "Wow!" experience for each of his clients, every day. As a Full Stack Web Developer and Realtor, Jonathon provides services tailored to your specific needs, at exceptional value.
						<br/><br/>
						...
						<br/><br/>
						Jonathon Nagatani: making life easier for you.</p>
					</div>
				</div>
			</div>
		);
